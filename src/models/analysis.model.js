...
exports.createAnalysis = async (userId, keyword, period, stats) => {
  const query = `
...
exports.addArticle = async (analysisId, press, title, stance) => {
...
exports.addInsight = async (analysisId, content) => {
